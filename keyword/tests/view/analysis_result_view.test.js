...
describe('AnalysisResultView', () => {
  ...
  test('render() should populate analysis container with keyword data', () => {    
  ...
  test('should handle more renderings', () => {
    view.render(keywordItem);
  ...
  test('should return tooltip trigger and tooltip elements', () => {
    view.render(keywordItem);
