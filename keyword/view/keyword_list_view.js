class KeywordListView {
    ...
    keywordListContainer.innerHTML = `
      ...
      <div class="keywords__filters-container">
        <div class="keywords__search-container">
          <div class="keywords__input-wrapper">
            <span class="keywords__input-wrapper__prefix">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="keywords__icon--small keywords__icon--block" aria-hidden="true">
        ...
        <div class="keywords__sort-container">
          <button type="button" class="keywords__sort-button" data-sort="desc">
            <span class="visually-hidden">Sort descending</span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="keywords__icon--medium keywords__icon--middle-align" aria-hidden="true">
          ...
          <button type="button" class="keywords__sort-button" data-sort="asc">
            <span class="visually-hidden">Sort ascending</span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="keywords__icon--medium keywords__icon--middle-align" aria-hidden="true">
              <path fill-rule="evenodd" d="M2 2.75A.75.75 0 0 1 2.75 2h9.5a.75.75 0 0 1 0 1.5h-9.5A.75.75 0 0 1 2 2.75ZM2 6.25a.75.75 0 0 1 .75-.75h5.5a.75.75 0 0 1 0 1.5h-5.5A.75.75 0 0 1 2 6.25Zm0 3.5A.75.75 0 0 1 2.75 9h3.5a.75.75 0 0 1 0 1.5h-3.5A.75.75 0 0 1 2 9.75ZM9.22 9.53a.75.75 0 0 1 0-1.06l2.25-2.25a.75.75 0 0 1 1.06 0l2.25 2.25a.75.75 0 0 1-1.06 1.06l-.97-.97v5.69a.75.75 0 0 1-1.5 0V8.56l-.97.97a.75.75 0 0 1-1.06 0Z" clip-rule="evenodd" />
            </svg>
          </button>
          <button type="button" class="keywords__remove-filters">
            <span class="visually-hidden">Remove all filters</span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="keywords__icon--medium keywords__icon--middle-align" aria-hidden="true">
  ...
  _renderDeleteButtonIfNeeded() {
    ...
    return `
      <button type="button" class="keyword-item__actions__button keyword-button--delete">
        <span class="visually-hidden">Delete keyword</span>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="keywords__icon--delete keywords__icon--medium keywords__icon--middle-align" aria-hidden="true">
    ...
    keywords.forEach(keywordItem => {
      ...
      item.innerHTML = `
        ...
        <div class="keyword-item__actions">
          ...
          <button type="button" class="keyword-item__actions__button keyword-button--highlight ${highlightClass}">
          ...
          <button type="button" data-section="result" class="keyword-item__actions__button keyword-button--view-details">
            <span class="visually-hidden">View keyword details</span>
            <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="keywords__icon--medium keywords__icon--middle-align" aria-hidden="true">
              <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
