        ...
        <div class="keywords__analysis-item_title-container">
          ...
          <div class="keywords__tooltip" tabindex="0" aria-describedby="tooltip-text">
            <div class="keywords__tooltip-content">
              ...
              <span id="tooltip-text" class="keywords__tooltip-text keywords--not-visible">The structural importance score highlights the impact of a keyword in strategic points of the page (title, meta description, H1-H6 tags, links, image alt attribute).</span>
            </div>                            
          </div>
        </div>  
